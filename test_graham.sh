...
module load gcc python/3.10.2 arrow/11 spark/3.3.0
# module load gcc/9.3.0 python nodejs perl mpi4py
source /home/rahit/projects/def-mtarailo/rahit/python_environments/.modspy310/bin/activate
...
time srun kedro run --runner=modspy_data.runner.DaskRunner