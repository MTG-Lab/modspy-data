...
#
# python slurm-launch.py --exp-name test \
#     --command "python your_file.py" --num-nodes 3
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="module load gcc/9.3 python/3.11.5 cuda/11.8.0 arrow/12.0.1 scipy-stack/2023b",
    )
    parser.add_argument(
        "--venv",
        type=str,
        help="Path to your python virtual environment activate script",
        default="./py311",
    )
    parser.add_argument(
        "--command",
    ...
    text = text.replace(VENV, args.venv)
    text = text.replace(
