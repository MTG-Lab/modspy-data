"""``modspy_data.extras.datasets`` is where you can find all additional data connectors to Kedro's defaults.
These data connectors are implementations of the ``AbstractDataset``.

.. warning::

   @TODO ``modspy_data.extras.datasets`` is deprecated and will be removed in Kedro 0.19.
