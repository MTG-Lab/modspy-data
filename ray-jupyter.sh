...
#SBATCH --job-name=modspy-ray_CV
#SBATCH -e ./logs/%J-modspy-ray_CV.err
#SBATCH -o ./logs/%J-modspy-ray_CV.out

#SBATCH --time=00-02:59:00           # time (DD-HH:MM:SS)
#SBATCH --mem=40GB                   # memory; default unit is megabytes
...
# python ./src/modspy_data/models/modspy.py --n-samples=16 --epoch=500
python ./src/modspy_data/models/modspy-eval.py
